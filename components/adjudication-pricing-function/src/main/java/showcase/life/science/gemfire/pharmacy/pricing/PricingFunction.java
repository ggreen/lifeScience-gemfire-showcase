...
public class PricingFunction implements Function<PricingRequest> {
    ...
    public void execute(FunctionContext<PricingRequest> context) {
        ...
        Region<String, DrugPricingInfo> drugRegion = ((RegionFunctionContext)context).getDataSet();
        Region<String, PlanPricingRule> planRegion = context.getCache().getRegion("PlanPricingRule");
